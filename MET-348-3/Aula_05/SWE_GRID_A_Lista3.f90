MODULE ModSWE
  ...
  PUBLIC :: DefineCI
  PUBLIC :: Solve_Forward_Beta_plane_Grid_A
   ...
   SUBROUTINE  Solve_Forward_Beta_plane_Grid_A(TermEqMomU, TermEqMomV, TermEqConH, u, v, h)
      ...
      DO j=1,Jdim
	    ...
	    betav = 0.0 !complete
            ...
            ! dt               |dydy    |
            !                  -       -
            vis2dudy= 0.0 !complete
            !
            ! d(u)          h        d(Bath)  
            ! -----   + g*----------*------- =0
            ! dt            H0-Bath    dx
            !
            gdbathx= 0.0 !complete
            !                                                                          -                      -    
            ...
            ! dt                   |dxdx     |
            !                       -       -
            vis2dvdx = 0.0 !complete
            !                  -             -
            ! d(v)            |    d(d(v))   |
            ! -----  - Neta * | ------------ | =0
            ! dt              |    dydy      |
            !                  -            -
            vis2dvdy = 0.0 !complete
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
PROGRAM  Main
  USE ModSWE, Only :    DefineCI,u,v,h,Idim,Jdim,DeltaT,&
                        f,nt,coordY,bath,&
			Solve_Forward_Beta_plane_Grid_A			
   IMPLICIT NONE
